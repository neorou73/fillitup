...
/*drop sequence logintoken_id_seq cascade;*/
drop table appgroup cascade;
/*drop sequence appgroup_id_seq cascade;*/
drop table appuser cascade;
/*drop sequence appuser_id_seq cascade;*/
drop table appdocument cascade;
/*drop sequence appdocument_id_seq cascade;*/
